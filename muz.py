...
# CONTACT INFORMATION (if you run into any issues etc): @imneverenough on discord.
...
TOKEN = "put your token in here"  # replace with your token
PREFIX = "?"
...
╔════════════════════════════════════╗
║  {Fore.WHITE}M U Z   C L I E N T   V1               {Fore.MAGENTA}║
╠════════════════════════════════════╣
...
║ {Fore.WHITE}CREATOR   {Fore.MAGENTA}| {Fore.WHITE}@imneverenough                   {Fore.MAGENTA}║
